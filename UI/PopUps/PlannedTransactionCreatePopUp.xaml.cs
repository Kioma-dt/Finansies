    ...
    IPopUp<CreatePlannedTransactionCommand>
{
    ...
    public PlannedTransactionCreatePopUp(PlannedTransactionCreatePopUpModel viewModel)
    {
        InitializeComponent();
